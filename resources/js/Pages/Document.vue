...
<template>
    <div class="pt-20">
        <div class="flex flex-col font-display relative">
            <div
                class="flex flex-row h-[70px] fixed top-0 left-0 right-0 shadow-slate-900/5 z-50 shadow-md bg-white border-b"
            >
                <div
                ...
                >
                    ...
                    <div class="flex flex-row space-x-3">
                        <nav class="text-sm leading-6 font-semibold text-slate-700 flex flex-row space-x-10 mr-10">
            ...
            <div class="flex flex-row">
                ...
                <main class="prose mx-auto w-full max-w-3xl py-10">
                    <h1>{{ title }}</h1>
                    <div v-html="html"></div>
                </main>
            </div>
