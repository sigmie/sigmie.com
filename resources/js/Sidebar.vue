    ...
    >
        <div class="h-full flex flex-col pt-12 pb-6">
            ...
            <a
                ...
                target="_blank"
                class="flex items-center justify-center gap-4 px-4 py-4 text-gray-500 hover:text-gray-300 transition-colors w-full"
            >
                <svg class="w-5 h-5 xl:w-6 xl:h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
