---
title: Magic Tags
short_description: LLM-generated taxonomy tags for Elasticsearch documents — optional embedding classification, a shared tag sidecar index, and reusable category vocabularies.
