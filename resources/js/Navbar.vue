...
const { enabled, showColumn, openChat } = useChatPanel();
...
<template>
    <div class="font-sans">
        ...
        <header
            ...
            :class="{ 'xl:right-[400px]': showColumn }"
        >
            <nav class="h-full flex items-center justify-between px-6 max-w-[92rem] mx-auto">
                ...
                <div class="flex items-center gap-1 flex-shrink-0">
                    <button
                        ...
                        @click="openChat"
                        aria-label="Ask AI"
                        class="flex items-center gap-1.5 mr-1 rounded-full bg-graphite px-3.5 py-2 text-[13px] font-medium text-white transition-colors hover:bg-black dark:bg-white dark:text-graphite dark:hover:bg-gray-100"
                    >
